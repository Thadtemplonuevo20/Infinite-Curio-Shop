      ...
      <main>
        ...
        <section className="py-20 border-y border-white/5 bg-white/[0.01]">
          <div className="container px-6 mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              {categories?.map((cat: { id: string; name; string; slug: string; image_url: strng}) => (
                <motion.div 
                  key={cat.id}
                  whileHover={{ y: -5 }}
          ...
          <div className="container px-6 mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Rare Drops & Treasures</h2>
              </div>
            ...
            <div className="mt-20 text-center">
              <button className="px-10 py-4 rounded-full border border-white/10 hover:bg-white/5 transition-all text-sm font-semibold tracking-widest uppercase">
        ...
        <section className="py-24 bg-primary/5 border-t border-white/5 relative overflow-hidden">
          ...
          <div className="container px-6 mx-auto text-center relative z-10">
            <h2 className="text-4xl font-bold mb-6">NEVER MISS A DROP.</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-lg mx-auto">
              <input 
                ...
                className="w-full h-14 bg-white/5 border border-white/10 rounded-full px-8 outline-none focus:border-primary transition-colors"
              />
        ...
        <div className="container px-6 mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold tracking-tighter text-sm">INFINITE CURIO</span>
            </div>
